...
class DioClient {
  ...
  Future<Response> post(String uri, {
    ...
    try {
      ...
      print("data: $data  queryParameters : $queryParameters  / options: $options / cancelToken : $cancelToken  / onSendProgress: $onSendProgress / onReceiveProgress: $onReceiveProgress ");
      return response;
    } on FormatException catch (_) {
      throw const FormatException("Unable to process the data");
    } catch (e) {
