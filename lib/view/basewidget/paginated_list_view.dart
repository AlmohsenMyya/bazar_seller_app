...
class PaginatedListView extends StatefulWidget {
  ...
  const PaginatedListView({
    ...
    required this.offset, required this.itemView, this.enabledPagination = true, this.reverse = false, required NeverScrollableScrollPhysics physics,
  }) : super(key: key);
    ...
    return Column(children: [
      ...
      widget.reverse ? const SizedBox() : widget.itemView,
       ...
       widget.totalSize == null || _offset! >= (widget.totalSize! / 10).ceil() || _offsetList.contains(_offset!+1) ? const SizedBox() : Center(child: Padding(
        padding: (_isLoading ) ?  const EdgeInsets.all(10) : EdgeInsets.zero,
